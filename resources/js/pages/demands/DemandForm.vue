...
const createDemand = (values, actions) => {
    ...
    axios
        .post("/api/demands/create", formData)
        .then((response) => {
...
const editDemand = (values, actions) => {
    ...
    axios
        .post(`/api/demands/${route.params.id}/update`, form, {
            headers: {
...
const getDemand = () => {
    axios.get(`/api/demands/${route.params.id}/show`).then(({ data }) => {
        form.name = data.name;
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input
                                                v-model="
                                                    form.number_of_people_needed
                                                "
                                                type="text"
                                                placeholder="No. Of Vacancy Available"
                                                class="form-control"
                                                :class="{
                                                    'is-invalid':
                                                        errors.number_of_people_needed,
                                                }"
                                                id="people"
                                            />
                                            <span class="invalid-feedback">{{
