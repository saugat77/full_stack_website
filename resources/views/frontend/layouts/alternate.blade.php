...
<head>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-53KR2MS3');
    </script>
    ...
    <meta name="description" content="The main objectives of Kantipur Overseas Services Pvt. Ltd. is to organize job placement for Nepalese job seekers in the international market in respect of solving unemployment crisis in the country and ensure the remarkable portion of remittance to Nepal.">
...
<body id="frontend">
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-53KR2MS3" height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript>
