      ...
      <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
          <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-1 mx-4">
              <a href="#" class="flex items-center">
                  ...
                  <span class="text-black lg:text-3xl sm:text-2xl mt-0">KANTIPUR OVERSEAS PVT LTD.</span>
              </a>
              <div class="flex items-center lg:order-2">
                  ...
                  <a href="{{ route('login') }}"
                      class="text-white lg:hidden bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">Login</a>
                      ...
                      <li>
                          <div class="dropdown block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0"
                              ...
                              <div class="dropdown-content w-full max-w-56 p-4">
                                  ...
                                  <div>
                                      <a href="{{ request()->is('/') ? '#chairmanmsg' : url('/') . '#chairmanmsg' }}"
